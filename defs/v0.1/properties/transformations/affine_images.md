...
**ID: [`https://schemas.httk.org/defs/v0.1/properties/transformations/affine_images`](https://schemas.httk.org/defs/v0.1/properties/transformations/affine_images.md)**  
...
Matrix/vector transform fields follow `/defs/v0.1/properties/symmetry/basis_transform`.
...
- `[{"affine_transformation": {"matrix": [["1", "0", "0"], ["0", "1", "0"], ["0", "0", "1"]], "vector": ["0", "0", "0"]}}]`
...
``` json
{
    "$id": "https://schemas.httk.org/defs/v0.1/properties/transformations/affine_images",
