...
**ID: [`https://schemas.httk.org/defs/v0.1/properties/transformations/transformations_per_hm_entry`](https://schemas.httk.org/defs/v0.1/properties/transformations/transformations_per_hm_entry.md)**  
...
``` json
{
    "$id": "https://schemas.httk.org/defs/v0.1/properties/transformations/transformations_per_hm_entry",
