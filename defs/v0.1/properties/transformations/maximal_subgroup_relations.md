...
**ID: [`https://schemas.httk.org/defs/v0.1/properties/transformations/maximal_subgroup_relations`](https://schemas.httk.org/defs/v0.1/properties/transformations/maximal_subgroup_relations.md)**  
...
``` json
{
    "$id": "https://schemas.httk.org/defs/v0.1/properties/transformations/maximal_subgroup_relations",
